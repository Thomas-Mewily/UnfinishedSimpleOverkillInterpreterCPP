#ifndef betterCPP__console_color
#define betterCPP__console_color
...
#define COLOR_DEBUG_IDENTIFIER     COLOR_FOREGROUND_CYAN
...
#define fprintf_title(f, str) fprintf(f, COLOR_DEBUG_CATEGORY str ":" COLOR_RESET "\n")
#define printf_title(str) fprintf_title(stdout, str)

#define printf_test_begin(str) printf(COLOR_DEBUG_CATEGORY "Testing " COLOR_DEBUG_IDENTIFIER str COLOR_RESET "... ");
#define printf_test_end() printf(COLOR_FOREGROUND_GREEN "success !" COLOR_RESET "\n");
