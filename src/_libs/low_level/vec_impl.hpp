#ifndef low_level__vec_impl
#define low_level__vec_impl
...
//template<typename T>
//using PrintFn = void(*)(T&, file*);

template <typename T>
void vec<T>::print(void (*print_fn) (T& val, file* f), file* f, bool display_outside, char begin, char end)
{
    primitives_try_get_printing_function
    check(print_fn != null);

    usize l = display_outside ? capacity : len;
