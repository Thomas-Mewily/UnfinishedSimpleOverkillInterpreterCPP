#ifndef low_level__fixed_vec_impl
#define low_level__fixed_vec_impl
...
template <typename T>
void fixed_vec<T>::print(void (*print_fn) (T& val, file* f), file* f, bool display_outside, char begin, char end)
{
