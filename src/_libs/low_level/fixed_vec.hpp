#ifndef low_level__fixed_vec
#define low_level__fixed_vec
...
class fixed_vec
{
    ...
    void print(void (*print_fn) (T& val, file* f) = null, file* f = stdout, bool display_outside = false, char begin = '[', char end = ']');
